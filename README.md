...
```bash
# Download the AppImage (v0.2.9)
wget https://github.com/MedGm/Ollie/releases/download/v0.2.9/Ollie_0.2.9_amd64.AppImage

# Make it executable
chmod +x Ollie_0.2.9_amd64.AppImage

# Run it
./Ollie_0.2.9_amd64.AppImage
```
